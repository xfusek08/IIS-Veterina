...
class AnimalEntity extends DatabaseEntity {
  ...
  protected function defColumns() {
    ...
    $this->addColumn(DataType::String,    'ani_race');

    $this->addSQLColumn(DataType::String, 'ani_species_text',
      'select spe_name  from Animal_species where spe_pk  = ani_species');
    ...
    $this->addSQLColumn(DataType::String, 'ani_sex_text',
      'select asex_description from Animal_sex where asex_shortcut = ani_sex');
